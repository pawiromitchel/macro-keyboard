...
sendToAHK = function (key)
      ...
      local file = io.open("C:\\Users\\mpawirodinomo\\Documents\\keypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
